...
export async function runSeed(): Promise<void> {
  ...
  `, [101, 1, 'HDFC Bank (Mock)', 'XXXX-XXXX-9876', 'Savings', 1, 'CNS-MOCK-9921', '2027-09-01 00:00:00']);

  // 3. Insert Transactions
  const txs = [
    // Income Transaction (August 2026 Salary)
    [101, 1, '2026-08-01', 'Monthly Salary Credit', 45000.00, 'Credit', 'Employer Inc', 'Unknown/Other', 'Other'],
    ...
    [101, 1, '2026-08-05', 'Zomato order', 1870.00, 'Debit', 'Zomato', 'Google Pay', 'Food'],
  ...
  console.log('  - Connected Accounts: 1 (Mock HDFC Bank, Active Consent)');
  console.log('  - Transactions: 18 records (Daily 2026-08-31 = ₹1,240, Monthly August = ₹12,700, Historical Jan-Apr)');
